...
var _MapApp = __webpack_require__(4);

var _MapApp2 = _interopRequireDefault(_MapApp);

var _ViewModel = __webpack_require__(6);
...
GoogleMapsLoader.load(function (google) {
	...
	var model = new _ViewModel2.default(myLocations, _knockout2.default);
		...
		value: function addMarker() {
			...
			if (!this.marker) {
				...
				this.marker.addListener('click', function () {
					_this3.stopMarkerAnimation();

					// Toggle Info Window
					if (_this3.status.infoWindowOpened) _this3.hideInfoWindow();else _this3.showInfoWindow();
				});
			} else {
